...
node_url = 'http://data.tainan.gov.tw/dataset'
node_url2 = 'http://data.tainan.gov.tw/dataset?page='
...
with open('tainan.2018.03.20.OD.csv', 'w', encoding = 'utf-8', newline='') as csvfile:
